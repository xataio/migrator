...
export const schemas = {
  ...
  count: z.number(),
  createdBy: z.string(),
  createdTime: z.string().transform((d) => new Date(d).toISOString()),
  currency: z.number(),
  date: z.string().transform((d) => new Date(d).toISOString()),
  dateTime: z.string().transform((d) => new Date(d).toISOString()),
  duration: z.number(),
  email: z.string(),
  externalSyncSource: z.never(),
  formula: z.union([z.string(), z.number()]),
  lastModifiedBy: z.string(),
  lastModifiedTime: z.string().transform((d) => new Date(d).toISOString()),
  longText: z.string(),
